        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categorii_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoriiId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stiri_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Stiri_Categorii_CategoriiId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Feedback_Stiri_StireId",
                        column: x => x.StireId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categorii_UserId",
                table: "Categorii",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Feedback_StireId",
                table: "Feedback",
                column: "StireId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stiri_CategoriiId",
                table: "Stiri",
                column: "CategoriiId");

            migrationBuilder.CreateIndex(
                name: "IX_Stiri_UserId",
                table: "Stiri",
                column: "UserId");
        }
